...
tuitsFile = open('../data/peruviantuits.tsv', 'a')
...
while(True):
    try:
        ...
        myStream.filter(locations=[-81.3281479193672, -18.3497280290367, -68.6730880806328, -0.0388399739132714])
        errorCounter+=1
        connectionReply = 0
